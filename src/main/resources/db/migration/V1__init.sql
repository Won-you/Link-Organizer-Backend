...
CREATE TABLE folder_invitations (
    ...
    folder_id      BIGINT REFERENCES shared_folders(folder_id) ON DELETE CASCADE NOT NULL,
    invited_by     BIGINT REFERENCES accounts(account_id) ON DELETE CASCADE NOT NULL,
